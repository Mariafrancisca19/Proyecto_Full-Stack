...
const QuienesSomos = () => {
    return (
        <div>
            <h2>Somos</h2>
            <p>Innovamos día con día para asegurarnos que los dueños de autos que puedan disfrutar sin preocupaciones. Utilizamos la más alta tecnología para generar soluciones globales que los acompañen de principio a fin.
